...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy | Verbo Academy" },
      {
        name: "description",
        content:
      ...
      <main className="relative z-10 mx-auto max-w-3xl px-6 pb-24 pt-10">
        ...
        <section className="mt-12">
          ...
          <P>
            ...
            <span className="text-white/80">Verbo Language Solutions, S.A.S.</span>, with fiscal
            domicile at{" "}
            <span className="text-white/80">C. Centenario 33, Apizaco, Tlaxcala, C.P. 90338</span>
        ...
        <section className="mt-10">
          ...
          <P>Questions about this policy, or about your data? Reach us through:</P>
          <ul className="mt-4 space-y-2 pl-1 text-sm leading-relaxed" style={{ color: "#cbd5e1" }}>
            <li>
